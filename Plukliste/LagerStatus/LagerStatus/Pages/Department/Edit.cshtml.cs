...
namespace LagerStatus.Pages.Department
{
    public class EditModel : PageModel
    {
        ...
        public EditModel(LagerStatus.Data.InventoryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> OnPostAsync(int id)
        {
                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    var dbValues = (Models.Department)databaseEntry.ToObject();
        ...
        {
            var deletedDepartment = new Models.Department();
        ...
        private async Task setDbErrorMessage(Models.Department dbValues,
                Models.Department clientValues, InventoryContext context)
        {
